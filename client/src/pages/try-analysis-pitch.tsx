                ...
                <Tabs defaultValue="single" className="w-full">
                  ...
                  <TabsContent value="single" className="space-y-4">
                    ...
                    <Button 
                      className="w-full" 
                      onClick={() => {
                        if (selectedType && selectedArea && selectedZone && selectedQuarter && selectedPhase && selectedSource) {
                          const newTry: Try = {
                            id: Math.random().toString(36).substr(2, 9),
                            x: Math.random() * 100, // Random placement since not clicked
                            y: Math.random() * 100,
                            type: selectedType,
                            area: selectedArea,
                            team: selectedTeam,
                      ...
                      disabled={!selectedType || !selectedArea || !selectedZone || !selectedQuarter || !selectedPhase || !selectedSource}
                    >
                      Add Try Data
                    </Button>
                  </TabsContent>
                  ...
                  <TabsContent value="template" className="space-y-4">
                    <div className="text-center p-6">
                      <p className="text-gray-600 mb-4">
                        Download the CSV template with all required fields for try analysis
                      </p>
                      <Button onClick={() => {
                        const template = [
                          'Team,Try Type,Zone,Quarter,Phase,Source,Field Area,Match Minute,X Position,Y Position',
                          'home,scrum,attacking_22,1,phase_1,scrum,Attacking 5m,15,25.5,85.2',
                          'away,lineout,defending_22m_halfway,2,phase_2_3,lineout,Own half,35,75.3,45.8'
                        ].join('\n');
                        ...
                        const a = document.createElement('a');
                        a.href = url;
                        a.download = 'try-analysis-template.csv';
                        a.click();
                        URL.revokeObjectURL(url);
                      }}>
