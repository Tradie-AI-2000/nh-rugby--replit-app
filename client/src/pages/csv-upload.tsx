    ...
    <div className="container mx-auto p-6 space-y-6">
      <div className="text-center space-y-4">
        <h1 className="text-3xl font-bold text-red-900">
          Import Your Rugby Data
        </h1>
        <p className="text-gray-600 max-w-2xl mx-auto">
          Upload your CSV files to import your North Harbour Rugby player data directly into the performance hub.
          Export each sheet from your Google Sheets as CSV files and upload them below.
        </p>
      </div>
