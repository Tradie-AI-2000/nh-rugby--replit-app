                  ...
                  <Card className="hover:shadow-lg transition-all duration-200 hover:scale-105 cursor-pointer border-2 hover:border-nh-red">
                    <CardHeader className="pb-3">
                      <div className="flex items-center justify-between mb-3">
                        <div className="flex items-center gap-3">
                          ...
                          <div className="flex-1">
                            ...
                            <p className="text-sm text-gray-600">#{player.rugbyProfile.jerseyNumber}</p>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <Badge className={`text-xs flex items-center gap-1 ${getStatusColor(player.status.fitness)}`}>
