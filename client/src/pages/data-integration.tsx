  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <div className="space-y-2">
        <h1 className="text-3xl font-bold text-nh-navy">Data Integration</h1>
        <p className="text-gray-600">Connect your Google Sheets to populate the dashboard with real player data</p>
      </div>
