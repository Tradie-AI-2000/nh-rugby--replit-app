    ...
    <div className="space-y-6">
      ...
      <Tabs defaultValue="overview" className="w-full">
        <TabsList className="grid w-full grid-cols-4">
          ...
          <TabsTrigger value="testing">Fitness Testing</TabsTrigger>
          <TabsTrigger value="strength">Strength & Gym</TabsTrigger>
          <TabsTrigger value="comparisons">Position Comparisons</TabsTrigger>
        </TabsList>
